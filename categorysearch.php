    ...
    <div id="layoutDefault">
        <div id="layoutDefault_content">
            <main>
                ...
                <nav class="navbar navbar-marketing navbar-expand-lg bg-white navbar-light">
                    <div class="container">
                        ...
                        <button class="navbar-toggler" type="button" data-toggle="collapse"
                                ...
                                aria-expanded="false" aria-label="Toggle navigation"><img src="img/menu.png"
                                                                                          style="height:20px;width:25px"/><i
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <a class="btn-teal btn rounded-pill px-4 ml-lg-4" href="backend/signin.php">Sign in<i
                                        class="fas fa-arrow-right ml-1"></i></a>
                            <a class="btn-teal btn rounded-pill px-4 ml-lg-4" href="backend/signup.php">Sign up<i
                                        class="fas fa-arrow-right ml-1"></i></a>
                        </div>
                    </div>
                </nav>
                ...
                $sqlSearch = "select * from posts where status=:status and categoryId=:categoryId and title like :searchkeyword";
                    ...
                    <div class="page-header-content pt-10">
                        <div class="container text-center">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    <h1 class="page-header-title mb-3">Search result
                                        for <?php echo $searchKeyWord ?></h1>
                ...
                <section class="bg-white py-10">
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            $sqlSearch = "select * from posts where status=:status and categoryId=:categoryId and title like :searchkeyword order by id DESC LIMIT 0,6 ";
                            $statementSearch = $pdo->prepare($sqlSearch);
                            $statementSearch->execute([
                                ':status' => 'Published',
                                ':categoryId'=>$categoryId,
                            ...
                            if ($count == 0) {
                                ...
                                while ($searchedPsot = $statementSearch->fetch(PDO::FETCH_ASSOC)) {
                                    ...
                                    $postCategory = $searchedPsot['categoryId'];
                                    ...
                                    <div class="col-md-6 col-xl-4 mb-5">
                                        <a class="card post-preview lift h-100"
                                           href="single.php?post_id=<?php echo $postId ?>"
